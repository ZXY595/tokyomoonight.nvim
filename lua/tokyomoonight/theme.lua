...
function M.setup(opts)
  ...
  local colors = require("tokyomoonight.colors").setup(opts)
  local groups = require("tokyomoonight.groups").setup(colors, opts)
  ...
  vim.g.colors_name = "tokyomoonight-" .. opts.style
