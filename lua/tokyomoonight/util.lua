...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("tokyomoonight.hsluv")
    if color ~= "NONE" then
...
---@param groups tokyomoonight.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/tokyomoonight-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, tokyomoonight.Cache
